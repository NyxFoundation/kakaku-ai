...
# カーセンサーの表記そのまま。「日野」ではなく「日野自動車」と出るので、
# 略称だけ持っていると輸入車に化ける（実際そうなっていた）
DOMESTIC_MAKERS = frozenset({
    "トヨタ", "日産", "ホンダ", "マツダ", "スバル", "スズキ", "ダイハツ", "三菱",
    "レクサス", "いすゞ", "日野", "日野自動車", "三菱ふそう", "ＵＤトラックス",
    "UDトラックス", "光岡", "光岡自動車", "ミツオカ", "トヨタ自動車", "日産自動車",
    "スバル自動車", "三菱自動車", "マツダ自動車", "トヨタ車体", "トヨタＬ＆Ｆ",
})
